...
export default function App() {
  ...
  const confirmDeleteCategory = () => {
    if (!categoryToDelete || deleteConfirmName !== categoryToDelete.name)
      return;
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Hash
              className={cn(
                "w-4 h-4",
                darkMode ? "text-zinc-900" : "text-white",
              )}
            />
          </div>
      ...
      >
        <button
          ...
          className={cn(
            ...
            darkMode
              ? "bg-zinc-900 text-zinc-500 hover:text-zinc-100"
        ...
        >
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedCategoryId === cat.id
                    ? darkMode
                      ? "bg-zinc-100 text-zinc-900 shadow-sm pr-7"
                      : "bg-zinc-900 text-white shadow-sm pr-7"
                    : darkMode
                      ? "bg-zinc-800 text-zinc-400 hover:bg-zinc-700"
                      : "bg-zinc-50 text-zinc-500 hover:bg-zinc-100",
                )}
              ...
              {selectedCategoryId === cat.id && cat.id !== "default" && (
                <button
                  ...
                  className={cn(
                    ...
                    darkMode
                      ? "text-zinc-900/60 hover:text-zinc-900"
          ...
          <button
            ...
            className={cn(
              ...
              darkMode
                ? "bg-zinc-800 text-zinc-500 hover:bg-zinc-700 hover:text-zinc-100"
            ...
            >
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2 min-w-0">
                  <div
                    ...
                    style={{
                      backgroundColor: `${getCategoryColor(snippet.categoryId)}15`,
                      color: getCategoryColor(snippet.categoryId),
                    }}
                  >
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      darkMode
                        ...
                        : "hover:bg-zinc-50 text-zinc-400 hover:text-red-500",
                    )}
                  >
              ...
              <div className="flex items-center justify-between">
                ...
                {snippet.type === "link" && (
                  <a
                    href={
                      snippet.content.startsWith("http")
                        ? snippet.content
                        : `https://${snippet.content}`
                    }
                    target="_blank"
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <div
              ...
              style={{
                width: `${Math.min(100, (snippets.length / 100) * 100)}%`,
              }}
            />
          </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {(["text", "code", "link", "contact"] as SnippetType[]).map(
                      (type) => (
                        <button
                          key={type}
          ...
          >
            <div className="p-6">
              ...
              >
                ...
                and <span className="font-bold text-red-500">all snippets</span>{" "}
